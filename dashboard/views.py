...
from emp.forms import EmployeeCreateForm
...
def leave_creation(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Leave Request Sent,wait for codezilla Managers response',
